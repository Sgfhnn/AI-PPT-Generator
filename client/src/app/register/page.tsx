            ...
            <div style={{
                ...
                <div className="glass-card" style={{ padding: '2rem' }}>
                    ...
                    <div style={{ display: 'grid', gap: '1rem' }}>
                        <button
                            onClick={() => window.location.href = `${(process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api').startsWith('http') ? '' : 'https://'}${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/auth/google`}
                        ...
                        <button
                            onClick={() => window.location.href = `${(process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api').startsWith('http') ? '' : 'https://'}${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/auth/github`}
                            className="btn btn-secondary"
                            style={{ width: '100%', justifyContent: 'center', gap: '0.75rem', cursor: 'pointer' }}
                        >
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
